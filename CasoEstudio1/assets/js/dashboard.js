        ...
        tasks.forEach(function(task){
            ...
            <div class="card bg-dark text-white rounded"> 
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-white">Due: ${task.dueDate}</small> </p>
                    <div class="comments-section">
                        <h6>Comments:</h6>
                        <ul class="list-group bg-dark text-white" id="comments-${task.id}">
                            ${task.comments.map(comment => `
                                <li class="list-group-item bg-dark text-white d-flex justify-content-between align-items-center rounded">
                                    ${comment}
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control bg-dark text-white rounded" placeholder="Add a comment" id="comment-input-${task.id}">
